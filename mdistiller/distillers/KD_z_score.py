...
class KD_z_scores(Distiller):
    def __init__(self, student, teacher, cfg):
        super(KD_z_scores, self).__init__(student, teacher)
    ...
    def forward_train(self, image_weak, image_strong, target, **kwargs):
        ...
        with torch.no_grad():
            ...
            logits_teacher_weak = self.z_score_norm(logits_teacher_weak)
            logits_teacher_strong = self.z_score_norm(logits_teacher_strong)
